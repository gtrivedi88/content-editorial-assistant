...
class ProgrammingElementsRule(BaseTechnicalRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None,
        ...
        for idx, sentence in enumerate(sentences):
            ...
            self._check_keyword_as_verb(sentence, idx, text, context, errors, code_ranges, sent_start)
            self._check_keyword_verb_suffix(sentence, idx, text, context, errors, code_ranges, sent_start)
        return errors

    def _check_keyword_as_verb(self, sentence, idx, text, context, errors, code_ranges, sent_start):
    ...
    def _check_keyword_verb_suffix(self, sentence, idx, text, context, errors, code_ranges, sent_start):
