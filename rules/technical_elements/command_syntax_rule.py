...
_KNOWN_CLI_TOOLS = frozenset([
    ...
    'curl', 'psql', 'oc', 'git', 'ssh', 'scp', 'rsync',
    'wget', 'tar', 'make', 'pip', 'npm', 'yarn', 'cargo', 'go',
])
...
class CommandSyntaxRule(BaseTechnicalRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None,
        ...
        for idx, sentence in enumerate(sentences):
            ...
            self._check_bare_command(sentence, idx, text, context, errors, code_ranges, sent_start)
        return errors
    ...
    def _check_bare_command(self, sentence, idx, text, context, errors, code_ranges, sent_start):
        ...
        for match in _BARE_CMD_RE.finditer(sentence):
            ...
            # Guard: skip if already in inline code
