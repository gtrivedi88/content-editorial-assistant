...
class ProductVersionsRule(BaseReferencesRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None,
        ...
        for idx, sentence in enumerate(sentences):
            ...
            self._check_prefix_with_period(sentence, idx, text, context, code_ranges, sent_start, errors)
            self._check_single_letter_prefix(sentence, idx, text, context, code_ranges, sent_start, errors)
            self._check_word_prefix(sentence, idx, text, context, code_ranges, sent_start, errors)
        return errors
