"""
Base Numbers and Measurement Rule
Abstract base class that all number/measurement rules inherit from.
"""
...
class BaseNumbersRule(BaseRule):
    """Abstract base class for all numbers and measurement rules."""

    def analyze(self, text: str, sentences: List[str], nlp=None,
                context=None, spacy_doc=None) -> List[Dict[str, Any]]:
        """Analyze text for number/measurement formatting violations."""
