"""
G Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter G.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter G from YAML config."""
...
class GWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for G-words and suggest alternatives."""
