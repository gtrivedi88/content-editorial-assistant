"""
V Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter V.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter V from YAML config."""
...
class VWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for V-words and suggest alternatives."""
