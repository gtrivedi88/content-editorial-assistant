"""
T Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter T.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter T from YAML config."""
...
class TWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for T-words and suggest alternatives."""
