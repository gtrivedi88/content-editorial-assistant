"""
E Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter E.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter E from YAML config."""
...
class EWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for E-words and suggest alternatives."""
