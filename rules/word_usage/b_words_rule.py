"""
B Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter B.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter B from YAML config."""
...
class BWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for B-words and suggest alternatives."""
