"""
W Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter W.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter W from YAML config."""
...
class WWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for W-words and suggest alternatives."""
