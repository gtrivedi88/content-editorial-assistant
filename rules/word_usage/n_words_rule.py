"""
N Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter N.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter N from YAML config."""
...
class NWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for N-words and suggest alternatives."""
