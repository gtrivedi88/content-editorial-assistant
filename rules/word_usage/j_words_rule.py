"""
J Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter J.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter J from YAML config."""
...
class JWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for J-words and suggest alternatives."""
