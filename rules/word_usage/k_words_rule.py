"""
K Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter K.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter K from YAML config."""
...
class KWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for K-words and suggest alternatives."""
