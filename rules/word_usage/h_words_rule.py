"""
H Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter H.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter H from YAML config."""
...
class HWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for H-words and suggest alternatives."""
