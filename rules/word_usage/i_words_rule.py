"""
I Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter I.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter I from YAML config."""
...
class IWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for I-words and suggest alternatives."""
