"""
M Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter M.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter M from YAML config."""
...
class MWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for M-words and suggest alternatives."""
