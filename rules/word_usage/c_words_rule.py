"""
C Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter C.
"""
import os
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter C from YAML config."""
...
class CWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for C-words and suggest alternatives."""
