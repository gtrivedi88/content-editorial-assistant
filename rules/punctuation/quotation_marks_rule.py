...
class QuotationMarksRule(BasePunctuationRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None, context=None) -> List[Dict[str, Any]]:
        ...
        for i, sent in enumerate(doc.sents):
            errors.extend(self._check_punctuation_placement(sent, i, text, context))
            errors.extend(self._check_inappropriate_use_for_emphasis(sent, i, text, context))

        return errors

    def _check_punctuation_placement(self, sent: Doc, sentence_index: int, text: str = None, context: Dict[str, Any] = None) -> List[Dict[str, Any]]:
    ...
    def _check_inappropriate_use_for_emphasis(self, sent: Doc, sentence_index: int, text: str = None, context: Dict[str, Any] = None) -> List[Dict[str, Any]]:
