...
class HyphensRule(BasePunctuationRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None) -> List[Dict[str, Any]]:
        ...
        # Linguistic Anchor: Prefixes that should be closed (unhyphenated)
