...
|Like all AI systems, CEA may occasionally generate inaccurate, fabricated, or misleading suggestions. Always verify AI output.
...
* xref:deployment-guide.adoc[Deployment guide] - Production deployment options
