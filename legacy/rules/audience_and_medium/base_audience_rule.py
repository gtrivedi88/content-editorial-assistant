...
Abstract base class that all audience/medium rules inherit from.
"""
...
class BaseAudienceRule(BaseRule):
    """Abstract base class for all audience and medium rules."""

    def analyze(self, text: str, sentences: List[str], nlp=None,
                context=None, spacy_doc=None) -> List[Dict[str, Any]]:
        """Analyze text for audience/medium violations."""
