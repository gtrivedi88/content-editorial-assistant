...
class ProceduresRule(BaseStructureRule):
    ...
    def analyze(
        ...
        for idx, sentence in enumerate(sentences):
            ...
            self._check_then(sentence, idx, text, context, code_spans, errors)
    ...
    # ------------------------------------------------------------------
    def _check_then(self, sentence, idx, text, context, code_spans, errors):
    ...
    def _check_imperative(self, sentence, idx, text, context, nlp, spacy_doc, errors):
        ...
        if first.lemma_.lower() in ('if', 'when', 'optional', 'unless'):
            return
