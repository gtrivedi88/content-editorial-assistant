"""
P Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter P.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter P from YAML config."""
...
class PWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for P-words and suggest alternatives."""
