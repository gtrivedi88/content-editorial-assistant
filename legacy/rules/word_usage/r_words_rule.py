"""
R Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter R.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter R from YAML config."""
...
class RWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for R-words and suggest alternatives."""
