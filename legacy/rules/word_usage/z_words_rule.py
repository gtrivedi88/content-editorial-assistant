"""
Z Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter Z.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter Z from YAML config."""
...
class ZWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for Z-words and suggest alternatives."""
