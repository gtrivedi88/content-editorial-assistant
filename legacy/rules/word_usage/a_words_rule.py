"""
A Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter A.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter A from YAML config."""
...
class AWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for A-words and suggest alternatives."""
