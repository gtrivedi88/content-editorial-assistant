"""
U Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter U.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter U from YAML config."""
...
class UWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for U-words and suggest alternatives."""
