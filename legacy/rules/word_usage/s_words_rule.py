"""
S Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter S.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter S from YAML config."""
...
class SWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for S-words and suggest alternatives."""
