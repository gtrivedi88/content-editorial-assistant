"""
O Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter O.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter O from YAML config."""
...
class OWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for O-words and suggest alternatives."""
