"""
F Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter F.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter F from YAML config."""
...
class FWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for F-words and suggest alternatives."""
