"""
X Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter X.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter X from YAML config."""
...
class XWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for X-words and suggest alternatives."""
