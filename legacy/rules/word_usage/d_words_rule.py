"""
D Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter D.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter D from YAML config."""
...
class DWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for D-words and suggest alternatives."""
