"""
Y Words Rule — Deterministic YAML lookup.
IBM Style Guide (p.284-414): Word usage entries for letter Y.
"""
import os
import re
...
def _load_config() -> Dict[str, str]:
    """Load word usage map for letter Y from YAML config."""
...
class YWordsRule(BaseWordUsageRule):
    """Flag incorrect word usage for Y-words and suggest alternatives."""
