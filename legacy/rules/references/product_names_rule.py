...
class ProductNamesRule(BaseReferencesRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None,
        ...
        for idx, sentence in enumerate(sentences):
            ...
            self._check_misspellings(sentence, idx, text, context, code_ranges, errors)
            self._check_prohibited_abbreviations(sentence, idx, text, context, code_ranges, errors)
            self._check_possessive_form(sentence, idx, text, context, code_ranges, errors)
        return errors
