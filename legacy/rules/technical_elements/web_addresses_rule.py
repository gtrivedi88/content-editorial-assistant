...
class WebAddressesRule(BaseTechnicalRule):
    ...
    def analyze(self, text: str, sentences: List[str], nlp=None,
        ...
        for idx, sentence in enumerate(sentences):
            self._check_bare_www(sentence, idx, text, context, errors)
            self._check_uppercase_protocol(sentence, idx, text, context, errors)
            self._check_trailing_slash(sentence, idx, text, context, errors)
        return errors

    def _check_bare_www(self, sentence, idx, text, context, errors):
    ...
    def _check_uppercase_protocol(self, sentence, idx, text, context, errors):
    ...
    def _check_trailing_slash(self, sentence, idx, text, context, errors):
