...
class ModelConfig:
    ...
    # LlamaStack uses specialized Lightrail environment variables
    LLAMASTACK_MODEL = os.getenv('CEA_MODEL_ID', 'style_analyzer_model')
    
    TEMPERATURE = float(os.getenv('MODEL_TEMPERATURE', '0.4'))
    MAX_TOKENS = int(os.getenv('MODEL_MAX_TOKENS', '3072'))
    ...
    def validate_config(cls) -> bool:
        ...
        if provider == 'ollama':
            ...
            return bool(os.environ.get('LIGHTRAIL_LLAMA_STACK_BASE_URL') and config.get('model'))
